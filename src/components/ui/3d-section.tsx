          ...
          >
            ...
            <TooltipProvider>
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent 
                  className="text-base  bg-gradient-to-r from-blue-600 to-teal-500 text-white border-none p-3 font-medium animate-in fade-in-50 data-[side=bottom]:slide-in-from-top-1"
                  side="top"
                  sideOffset={5}
                >
